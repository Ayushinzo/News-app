...
let newsHeading = document.querySelector(".newsHeading h1")
...
async function print(){
    ...
    const search = para.get('search')
    newsHeading.innerText = search
    // let data = await fetch(`https://newsapi.org/v2/everything?q=${search}&pageSize=40&apiKey=63dd9a6301d34536b0874e1958472e6a`)
